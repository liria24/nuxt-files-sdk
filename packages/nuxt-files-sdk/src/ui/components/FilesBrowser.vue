...
const ui = computed(() => resolveFilesTheme(theme, appConfig.value.ui?.filesBrowser))
...
<template>
    <div :dir="dir" :class="ui.root({ class: [props.ui?.root, props.class] })">
        ...
        <nav :class="ui.breadcrumb({ class: props.ui?.breadcrumb })" aria-label="Breadcrumb">
            <FilesControlButton
                :options="{ ...props.home, ariaLabel: props.home?.ariaLabel ?? t('browser.root') }"
                icon="home"
            ...
            <template v-for="crumb in breadcrumbs" :key="crumb.prefix">
                ...
                <FilesControlButton
                    :options="props.breadcrumb"
                    :label="crumb.label"
                    default-variant="ghost"
                    @click="enter(crumb.prefix)"
                />
            </template>
            <FilesControlButton
